...
export { PillagerPreferredWeapons, WitherSkeletonDislikedWeapons, BreaksDecoratedPots, Spears, Shovels, Hoes, LlamaFood, WolfCollarDyes, CatCollarDyes, LoomPatterns, LoomDyes, MetalNuggets, ShearableFromCopperGolem, GazeDisguiseEquipment, MapInvisibilityEquipment, GoatFood, SheepFood, CowFood, ParrotPoisonousFood, ParrotFood, TurtleFood, StriderTemptItems, StriderFood, RabbitFood, PigFood, PandaEatsFromGround, PandaFood, NautilusFood, NautilusBucketFood, NautilusTamingItems, LlamaTemptItems, HoglinFood, FrogFood, ChickenFood, ArmadilloFood, CamelHuskFood, CamelFood, HappyGhastTemptItems, HappyGhastFood, Harnesses, HorseTemptItems, ZombieHorseFood, HorseFood, CatFood, OcelotFood, WolfFood, Meat, FurnaceMinecartFuel, CauldronCanRemoveDye, Dyes, Pickaxes, BookCloningTarget, VillagerPicksUp, VillagerPlantableSeeds, SnifferFood, NoteblockTopInstruments, BookshelfBooks, TrimMaterials, TrimmableArmor, Skulls, HeadArmor, ChestArmor, LegArmor, DecoratedPotIngredients, FootArmor, Axes, DecoratedPotSherds, Swords, CreeperIgniters, DrownedPreferredWeapons, PiglinPreferredWeapons, Compasses, SkeletonPreferredWeapons, ClusterMaxHarvestables, AxolotlFood, FreezeImmuneWearables, StoneCraftingMaterials, RepairsWolfArmor, RepairsTurtleHelmet, RepairsNetheriteArmor, RepairsDiamondArmor, RepairsGoldArmor, RepairsIronArmor, RepairsChainArmor, RepairsCopperArmor, RepairsLeatherArmor, NetheriteToolMaterials, DiamondToolMaterials, GoldToolMaterials, IronToolMaterials, CopperToolMaterials, StoneToolMaterials, NonFlammableWood, WoodenToolMaterials, BrewingFuel, FoxFood, DuplicatesAllays, PiglinSafeArmor, PiglinFood, PiglinLoved, IgnoredByPiglinBabies, PiglinRepellents, BeaconPaymentItems, LecternBooks, Arrows, Coals, CreeperDropMusicDiscs, Fishes, Eggs, ChestBoats, Bundles, Boats, Banners, BeeFood, HangingSigns, Signs, Bars, Lanterns, WoodenShelves, Chains, Copper, LightningRods, CopperGolemStatues, CopperChests, ShulkerBoxes, CompletesFindTreeTutorial, Terracotta, GrassBlocks, Mud, MossBlocks, Dirt, CopperOres, EmeraldOres, CoalOres, LapisOres, DiamondOres, RedstoneOres, IronOres, Candles, DampensVibrations, GoldOres, SoulFireBaseBlocks, Fences, Beds, Flowers, SmallFlowers, Trapdoors, WoodenTrapdoors, Leaves, Stairs, Anvil, Rails, Slabs, Walls, SmeltsToGlass, Sand, Logs, LogsThatBurn, WartBlocks, WarpedStems, CrimsonStems, CherryLogs, JungleLogs, MangroveLogs, SpruceLogs, AcaciaLogs, BirchLogs, PaleOakLogs, DarkOakLogs, BambooBlocks, Saplings, OakLogs, Doors, WoodenPressurePlates, FenceGates, WoodenFences, WoodenSlabs, WoodenStairs, WoodenDoors, WoolCarpets, Buttons, StoneButtons, WoodenButtons, StoneBricks, Planks, Wool, EnchantableVanishing, EnchantableCrossbow, EnchantableEquippable, EnchantableDurability, EnchantableBow, EnchantableLunge, EnchantableTrident, EnchantableFishing, EnchantableMiningLoot, EnchantableMining, EnchantableMace, EnchantableWeapon, EnchantableSharpWeapon, EnchantableFireAspect, EnchantableSweeping, EnchantableMeleeWeapon, EnchantableArmor, EnchantableChestArmor, EnchantableLegArmor, EnchantableHeadArmor, EnchantableFootArmor };